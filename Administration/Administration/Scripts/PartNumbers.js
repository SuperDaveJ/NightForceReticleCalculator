/*
''' <summary>
''' This module is used to contain the javascript functions for the part numbers page
''' </summary>
*/

var editMessage = "EditMessageHidden";
var deleteMessage = "DeleteMessageHidden";
var partNumberIdHidden = "SelectedPartNumberIdHidden";
...
*/
function PartNumbersOnAjaxRequestStart(sender, eventArgs) 
{

} //PartNumbersOnAjaxRequestStart
...
''' <param name="eventArgs">Event arguments</param>
*/
function PartNumbersOnAjaxResponseEnd(sender, eventArgs) 
{

} //PartNumbersOnAjaxResponseEnd
...
{
    var partNumberIdHiddenVal = $get(partNumberIdHidden);

    if (partNumberIdHiddenVal !== null) 
    {
        partNumberIdHiddenVal.value = partNumberId;
